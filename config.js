...
global.caption = process.env.CAPTION || global.caption || "▇▇ 𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 𝙿𝚁𝙴𝚇𝚉𝚈 ▇▇═─ 💦" 
...
module.exports = {
  ...
  caption : global.caption || "▇▇ 𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 𝙿𝚁𝙴𝚇𝚉𝚈 ▇▇═─ 💦", // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ sᴜʜᴀɪʟ²²¹-ᴍᴅ 』```", //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@suhailtechinfo0"),
